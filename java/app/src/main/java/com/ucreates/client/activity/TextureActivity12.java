...
import com.ucreates.client.behaviour.TextureBehaviour12;
...
public class TextureActivity12 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour12> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour12>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour12(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour12 behaviour = this.behaviours.get(i);

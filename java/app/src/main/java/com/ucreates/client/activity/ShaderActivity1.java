...
import com.ucreates.client.behaviour.ShaderBehaviour1;
...
public class ShaderActivity1 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<ShaderBehaviour1> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<ShaderBehaviour1>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new ShaderBehaviour1(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            ShaderBehaviour1 behaviour = this.behaviours.get(i);

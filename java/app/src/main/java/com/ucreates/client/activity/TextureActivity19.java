...
import com.ucreates.client.behaviour.TextureBehaviour19;
...
public class TextureActivity19 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour19> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour19>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour19(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour19 behaviour = this.behaviours.get(i);

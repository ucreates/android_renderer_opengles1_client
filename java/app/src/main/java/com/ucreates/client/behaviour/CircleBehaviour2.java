...
import com.ucreates.renderer.asset.mesh.GLES1CircleAsset2;
import com.ucreates.renderer.entity.GLES1Color;
public class CircleBehaviour2 extends BaseBehaviour {
    public GLES1BaseAsset asset;
    public CircleBehaviour2(Context context) {
        super(context);
        this.asset = new GLES1CircleAsset2(0.5f, 100, GLES1Color.white);
        this.asset.create();
        return;
    }
    @Override

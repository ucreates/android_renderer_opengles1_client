...
import com.ucreates.renderer.asset.mesh.GLES1SphereAsset4;
import com.ucreates.renderer.entity.GLES1Color;
public class TextureBehaviour27 extends BaseBehaviour {
    public GLES1BaseAsset asset;
    private float rotate;
    public TextureBehaviour27(Context context) {
        super(context);
        this.asset = new GLES1SphereAsset4(1, 100, GLES1Color.white);

...
import com.ucreates.client.behaviour.CircleBehaviour4;
...
public class CircleActivity4 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<CircleBehaviour4> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<CircleBehaviour4>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new CircleBehaviour4(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            CircleBehaviour4 behaviour = this.behaviours.get(i);

...
import com.ucreates.client.behaviour.TextureBehaviour23;
...
public class TextureActivity23 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour23> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour23>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour23(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour23 behaviour = this.behaviours.get(i);

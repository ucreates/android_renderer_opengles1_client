...
import com.ucreates.client.behaviour.TextureBehaviour1;
...
public class TextureActivity1 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour1> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour1>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour1(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour1 behaviour = this.behaviours.get(i);

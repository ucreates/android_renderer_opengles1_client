...
import com.ucreates.client.behaviour.MaterialBehaviour1;
...
public class LightingActivity3 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<MaterialBehaviour1> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<MaterialBehaviour1>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new MaterialBehaviour1(context));
        }
        GLES1Light light = new GLES1Light(GLES11.GL_LIGHT0);
        light.setPosition(0, 0, -3.0f);
        light.setAmbient(new GLES1Color(0.25f, 0.25f, 0.25f, 1.0f));
        light.setDiffuse(new GLES1Color(0.5f, 0.5f, 0.5f, 1.0f));
        light.setSpecular(new GLES1Color(0.25f, 0.25f, 0.25f, 1.0f));

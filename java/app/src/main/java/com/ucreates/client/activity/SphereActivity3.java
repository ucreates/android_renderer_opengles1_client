...
public class SphereActivity3 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<SphereBehaviour3> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<SphereBehaviour3>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new SphereBehaviour3(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            SphereBehaviour3 behaviour = this.behaviours.get(i);

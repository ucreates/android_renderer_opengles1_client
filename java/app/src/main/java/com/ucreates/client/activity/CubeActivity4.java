...
import com.ucreates.client.behaviour.CubeBehaviour4;
...
public class CubeActivity4 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<CubeBehaviour4> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<CubeBehaviour4>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new CubeBehaviour4(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            CubeBehaviour4 behaviour = this.behaviours.get(i);

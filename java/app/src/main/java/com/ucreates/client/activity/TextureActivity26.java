...
import com.ucreates.client.behaviour.TextureBehaviour26;
...
public class TextureActivity26 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour26> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour26>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour26(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour26 behaviour = this.behaviours.get(i);

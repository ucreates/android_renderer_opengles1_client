...
import com.ucreates.client.behaviour.TextureBehaviour18;
...
public class TextureActivity18 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour18> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour18>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour18(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour18 behaviour = this.behaviours.get(i);

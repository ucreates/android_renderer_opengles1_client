...
import com.ucreates.client.behaviour.TriangleBehaviour4;
...
public class TriangleActivity4 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TriangleBehaviour4> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TriangleBehaviour4>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TriangleBehaviour4(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TriangleBehaviour4 behaviour = this.behaviours.get(i);

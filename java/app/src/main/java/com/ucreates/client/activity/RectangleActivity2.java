...
import com.ucreates.client.behaviour.RectangleBehaviour2;
...
public class RectangleActivity2 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<RectangleBehaviour2> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<RectangleBehaviour2>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new RectangleBehaviour2(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            RectangleBehaviour2 behaviour = this.behaviours.get(i);

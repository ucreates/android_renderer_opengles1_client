...
import com.ucreates.client.behaviour.TextureBehaviour7;
...
public class TextureActivity7 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour7> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour7>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour7(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour7 behaviour = this.behaviours.get(i);

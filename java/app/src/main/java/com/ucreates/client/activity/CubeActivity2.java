...
import com.ucreates.client.behaviour.CubeBehaviour2;
...
public class CubeActivity2 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<CubeBehaviour2> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<CubeBehaviour2>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new CubeBehaviour2(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            CubeBehaviour2 behaviour = this.behaviours.get(i);

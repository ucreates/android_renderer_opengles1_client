...
import com.ucreates.renderer.asset.mesh.GLES1CircleAsset4;
import com.ucreates.renderer.entity.GLES1Color;
public class CircleBehaviour4 extends BaseBehaviour {
    public GLES1BaseAsset asset;
    public CircleBehaviour4(Context context) {
        super(context);
        this.asset = new GLES1CircleAsset4(0.5f, 100, GLES1Color.white);
        this.asset.create();
        return;
    }
    @Override

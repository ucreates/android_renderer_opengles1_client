...
import com.ucreates.client.behaviour.TextureBehaviour5;
...
public class TextureActivity5 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour5> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour5>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour5(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour5 behaviour = this.behaviours.get(i);

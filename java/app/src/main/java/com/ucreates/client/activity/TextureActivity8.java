...
import com.ucreates.client.behaviour.TextureBehaviour8;
...
public class TextureActivity8 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour8> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour8>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour8(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour8 behaviour = this.behaviours.get(i);

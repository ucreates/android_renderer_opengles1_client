...
import com.ucreates.renderer.asset.mesh.GLES1SphereAsset3;
import com.ucreates.renderer.entity.GLES1Color;
public class TextureBehaviour22 extends BaseBehaviour {
    public GLES1BaseAsset asset;
    private float rotate;
    public TextureBehaviour22(Context context) {
        super(context);
        this.asset = new GLES1SphereAsset3(1, 100, GLES1Color.white);

...
import com.ucreates.client.behaviour.TextureBehaviour10;
...
public class TextureActivity10 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour10> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour10>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour10(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour10 behaviour = this.behaviours.get(i);

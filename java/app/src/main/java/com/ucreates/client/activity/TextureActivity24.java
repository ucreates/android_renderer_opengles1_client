...
import com.ucreates.client.behaviour.TextureBehaviour24;
...
public class TextureActivity24 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour24> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour24>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour24(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour24 behaviour = this.behaviours.get(i);

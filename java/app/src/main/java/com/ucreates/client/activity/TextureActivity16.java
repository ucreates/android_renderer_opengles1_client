...
import com.ucreates.client.behaviour.TextureBehaviour16;
...
public class TextureActivity16 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour16> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour16>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour16(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour16 behaviour = this.behaviours.get(i);

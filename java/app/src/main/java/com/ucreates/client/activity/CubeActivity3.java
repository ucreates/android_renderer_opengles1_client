...
import com.ucreates.client.behaviour.CubeBehaviour3;
...
public class CubeActivity3 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<CubeBehaviour3> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<CubeBehaviour3>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new CubeBehaviour3(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            CubeBehaviour3 behaviour = this.behaviours.get(i);

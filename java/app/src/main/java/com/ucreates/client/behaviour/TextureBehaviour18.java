...
import com.ucreates.renderer.asset.polygon.GLES1TriangleAsset3;
import com.ucreates.renderer.entity.GLES1Color;
public class TextureBehaviour18 extends BaseBehaviour {
    public GLES1BaseAsset asset;
    public TextureBehaviour18(Context context) {
        super(context);
        this.asset = new GLES1TriangleAsset3(1, 1, GLES1Color.white);

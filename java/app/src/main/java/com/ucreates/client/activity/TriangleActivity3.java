...
import com.ucreates.client.behaviour.TriangleBehaviour3;
...
public class TriangleActivity3 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TriangleBehaviour3> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TriangleBehaviour3>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TriangleBehaviour3(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TriangleBehaviour3 behaviour = this.behaviours.get(i);

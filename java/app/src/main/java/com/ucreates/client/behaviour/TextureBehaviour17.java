...
import com.ucreates.renderer.asset.mesh.GLES1CubeAsset2;
import com.ucreates.renderer.asset.mesh.GLES1SphereAsset2;
import com.ucreates.renderer.entity.GLES1Color;
public class TextureBehaviour17 extends BaseBehaviour {
    public GLES1BaseAsset asset;
    private float rotate;
    public TextureBehaviour17(Context context) {
        super(context);
        this.asset = new GLES1SphereAsset2(1, 100, GLES1Color.white);

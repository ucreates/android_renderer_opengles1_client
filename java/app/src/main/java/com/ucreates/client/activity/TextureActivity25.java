...
import com.ucreates.client.behaviour.TextureBehaviour25;
...
public class TextureActivity25 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour25> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour25>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour25(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour25 behaviour = this.behaviours.get(i);

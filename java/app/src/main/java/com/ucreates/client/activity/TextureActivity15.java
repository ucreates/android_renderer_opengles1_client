...
import com.ucreates.client.behaviour.TextureBehaviour15;
...
public class TextureActivity15 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour15> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour15>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour15(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour15 behaviour = this.behaviours.get(i);

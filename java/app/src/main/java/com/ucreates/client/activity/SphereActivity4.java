...
import com.ucreates.client.behaviour.SphereBehaviour4;
...
public class SphereActivity4 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<SphereBehaviour4> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<SphereBehaviour4>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new SphereBehaviour4(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            SphereBehaviour4 behaviour = this.behaviours.get(i);

...
import com.ucreates.renderer.asset.polygon.GLES1RectangleAsset4;
import com.ucreates.renderer.entity.GLES1Color;
public class RectangleBehaviour4 extends BaseBehaviour {
    public GLES1BaseAsset asset;
    public RectangleBehaviour4(Context context) {
        super(context);
        this.asset = new GLES1RectangleAsset4(1, 1, GLES1Color.white);
        this.asset.create();
        return;
    }
    @Override

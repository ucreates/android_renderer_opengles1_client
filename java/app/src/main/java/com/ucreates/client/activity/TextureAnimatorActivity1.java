...
import com.ucreates.client.behaviour.TextureAnimatorBehaviour1;
...
public class TextureAnimatorActivity1 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureAnimatorBehaviour1> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureAnimatorBehaviour1>();
        this.behaviours.add(new TextureAnimatorBehaviour1(context));
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureAnimatorBehaviour1 behaviour = this.behaviours.get(i);

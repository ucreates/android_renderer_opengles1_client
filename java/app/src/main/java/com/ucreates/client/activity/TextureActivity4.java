...
import com.ucreates.client.behaviour.TextureBehaviour4;
...
public class TextureActivity4 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour4> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour4>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour4(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour4 behaviour = this.behaviours.get(i);

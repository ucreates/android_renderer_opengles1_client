...
import com.ucreates.renderer.asset.mesh.GLES1CubeAsset4;
import com.ucreates.renderer.entity.GLES1Color;
public class TextureBehaviour26 extends BaseBehaviour {
    public GLES1BaseAsset asset;
    private float rotate;
    public TextureBehaviour26(Context context) {
        super(context);
        this.asset = new GLES1CubeAsset4(1, 1, 1, GLES1Color.white);

...
import com.ucreates.client.behaviour.TextureBehaviour6;
...
public class TextureActivity6 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour6> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour6>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour6(context));
        }

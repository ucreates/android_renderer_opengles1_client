...
import com.ucreates.client.behaviour.CircleBehaviour3;
...
public class CircleActivity3 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<CircleBehaviour3> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<CircleBehaviour3>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new CircleBehaviour3(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            CircleBehaviour3 behaviour = this.behaviours.get(i);

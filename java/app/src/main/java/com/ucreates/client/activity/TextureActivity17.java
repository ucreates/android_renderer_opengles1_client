...
import com.ucreates.client.behaviour.TextureBehaviour17;
...
public class TextureActivity17 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour17> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour17>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour17(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour17 behaviour = this.behaviours.get(i);

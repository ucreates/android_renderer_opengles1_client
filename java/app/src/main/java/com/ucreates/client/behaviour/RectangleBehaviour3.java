...
import com.ucreates.renderer.asset.polygon.GLES1RectangleAsset3;
import com.ucreates.renderer.entity.GLES1Color;
public class RectangleBehaviour3 extends BaseBehaviour {
    public GLES1BaseAsset asset;
    public RectangleBehaviour3(Context context) {
        super(context);
        this.asset = new GLES1RectangleAsset3(1, 1, GLES1Color.white);
        this.asset.create();
        return;
    }
    @Override

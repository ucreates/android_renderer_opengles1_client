...
import com.ucreates.client.behaviour.BlendBehaviour;
...
public class BlendActivity1 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<BlendBehaviour> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<BlendBehaviour>();
        this.behaviours.add(new BlendBehaviour1(context));
        this.behaviours.add(new BlendBehaviour2(context));
    ...
    public void onDrawFrame(GL10 gl) {
        Comparator<BlendBehaviour> comparator = new Comparator<BlendBehaviour>() {
            @Override
            public int compare(BlendBehaviour o1, BlendBehaviour o2) {
                if (o1.asset.transform.position.z < o2.asset.transform.position.z) {
                    return -1;
                } else if (o1.asset.transform.position.z == o2.asset.transform.position.z) {
                    return 0;
                } else {
                    return 1;
                }

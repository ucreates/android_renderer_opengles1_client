...
import com.ucreates.client.behaviour.RectangleBehaviour3;
...
public class RectangleActivity3 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<RectangleBehaviour3> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<RectangleBehaviour3>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new RectangleBehaviour3(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            RectangleBehaviour3 behaviour = this.behaviours.get(i);

...
import com.ucreates.client.behaviour.TextureBehaviour22;
...
public class TextureActivity22 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour22> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour22>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour22(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour22 behaviour = this.behaviours.get(i);

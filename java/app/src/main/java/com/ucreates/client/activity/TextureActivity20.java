...
import com.ucreates.client.behaviour.TextureBehaviour20;
...
public class TextureActivity20 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour20> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour20>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour20(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour20 behaviour = this.behaviours.get(i);

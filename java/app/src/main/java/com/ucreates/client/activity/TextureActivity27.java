...
import com.ucreates.client.behaviour.TextureBehaviour27;
...
public class TextureActivity27 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour27> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour27>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour27(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour27 behaviour = this.behaviours.get(i);

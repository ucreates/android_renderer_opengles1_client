...
import com.ucreates.client.behaviour.RectangleBehaviour4;
...
public class RectangleActivity4 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<RectangleBehaviour4> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<RectangleBehaviour4>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new RectangleBehaviour4(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            RectangleBehaviour4 behaviour = this.behaviours.get(i);

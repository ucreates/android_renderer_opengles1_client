...
import com.ucreates.client.behaviour.TextureBehaviour9;
...
public class TextureActivity9 extends AppCompatActivity implements GLSurfaceView.Renderer {
    private GLES1Renderer renderer;
    private ArrayList<TextureBehaviour9> behaviours;
    @Override
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.behaviours = new ArrayList<TextureBehaviour9>();
        for (int i = 0; i < 1; i++) {
            this.behaviours.add(new TextureBehaviour9(context));
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        for (int i = 0; i < this.behaviours.size(); i++) {
            TextureBehaviour9 behaviour = this.behaviours.get(i);
